package kabam.rotmg.arena.view
{
   ...
   public class ContinueOrQuitDialog extends Sprite
   {
      ...
      private var background:DialogBackground;
      
      private var title:StaticTextDisplay;
      
      private var quitSubtitle:StaticTextDisplay;
      
      private var quitButton:StaticTextButton;
      
      private var continueButton:LegacyBuyButton;
      
      private var restartSubtitle:StaticTextDisplay;
      
      private var processingText:StaticTextDisplay;
      
      public function ContinueOrQuitDialog(param1:int, param2:Boolean)
      {
         this.background = this.makeBackground();
         this.title = this.makeTitle();
         this.quitSubtitle = this.makeSubtitle();
         this.quitButton = this.makeQuitButton();
         this.continueButton = this.makeContinueButton();
         this.restartSubtitle = this.makeSubtitle();
         this.processingText = this.makeSubtitle();
         super();
         this.cost = param1;
