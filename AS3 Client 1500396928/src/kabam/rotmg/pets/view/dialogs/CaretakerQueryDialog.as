package kabam.rotmg.pets.view.dialogs
{
   ...
   public class CaretakerQueryDialog extends Sprite
   {
      ...
      private var layoutWaiter:SignalWaiter;
      
      private var container:DisplayObjectContainer;
      
      private var background:PopupWindowBackground;
      
      private var caretaker:CaretakerQueryDialogCaretaker;
      
      private var title:TextFieldDisplayConcrete;
      
      private var categories:CaretakerQueryDialogCategoryList;
      
      private var backButton:DeprecatedTextButton;
      
      private var closeButton:DeprecatedTextButton;
      
      public var closed:Signal;
      
      public function CaretakerQueryDialog()
      {
         this.layoutWaiter = this.makeDeferredLayout();
         this.container = this.makeContainer();
         this.background = this.makeBackground();
         this.caretaker = this.makeCaretaker();
         this.title = this.makeTitle();
         this.categories = this.makeCategoryList();
         this.backButton = this.makeBackButton();
         this.closeButton = this.makeCloseButton();
         this.closed = new NativeMappedSignal(this.closeButton,MouseEvent.CLICK);
         super();
      }
