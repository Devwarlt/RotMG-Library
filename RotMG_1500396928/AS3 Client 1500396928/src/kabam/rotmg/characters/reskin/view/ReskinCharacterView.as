package kabam.rotmg.characters.reskin.view
{
   ...
   public class ReskinCharacterView extends Sprite
   {
      ...
      private var layoutListener:SignalWaiter;
      ...
      private var cancel:DeprecatedTextButton;

      private var select:DeprecatedTextButton;
      ...
      {
         super();
         this.layoutListener = this.makeLayoutWaiter();
         this.background = this.makeBackground();
         this.title = this.makeTitle();
         this.list = this.makeListView();
         this.cancel = this.makeCancelButton();
         this.select = this.makeSelectButton();
         cancelled = new NativeMappedSignal(this.cancel,MouseEvent.CLICK);
         selected = new NativeMappedSignal(this.select,MouseEvent.CLICK);
      }
