package kabam.rotmg.packages.view
{
   ...
   public class BusyIndicator extends Sprite
   {
      ...
      private var innerCircleMask:Sprite;
      
      private var quarterCircleMask:Sprite;
      ...
      {
         this.pinwheel = this.makePinWheel();
         this.innerCircleMask = this.makeInner();
         this.quarterCircleMask = this.makeQuarter();
