package kabam.rotmg.util.components
{
   ...
   public class LegacyBuyButton extends BuyButton
   {
      ...
      private var enabledFill:GraphicsSolidFill;
      
      private var disabledFill:GraphicsSolidFill;
      ...
      public function LegacyBuyButton(param1:String, param2:int, param3:int, param4:int, param5:Boolean = false, param6:Boolean = false)
      {
         ...
         this.graphicsData = new <IGraphicsData>[this.enabledFill,this.graphicsPath,GraphicsUtil.END_FILL];
         super();
         this.prefix = param1;
